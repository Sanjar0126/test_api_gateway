...
func (c *postServiceClient) Get(ctx context.Context, in *PostId, opts ...grpc.CallOption) (*Post, error) {
	out := new(Post)
...
func (c *postServiceClient) Update(ctx context.Context, in *Post, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedPostServiceServer) Update(context.Context, *Post) (*emptypb.Empty, error) {
