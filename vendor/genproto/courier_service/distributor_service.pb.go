...
type DistributorServiceClient interface {
	...
	Delete(ctx context.Context, in *DeleteDistributorRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	...
	DeletePark(ctx context.Context, in *DeleteParkRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *distributorServiceClient) Delete(ctx context.Context, in *DeleteDistributorRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *distributorServiceClient) DeletePark(ctx context.Context, in *DeleteParkRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type DistributorServiceServer interface {
	...
	Delete(context.Context, *DeleteDistributorRequest) (*emptypb.Empty, error)
	...
	DeletePark(context.Context, *DeleteParkRequest) (*emptypb.Empty, error)
}
...
func (*UnimplementedDistributorServiceServer) Delete(ctx context.Context, req *DeleteDistributorRequest) (*emptypb.Empty, error) {
...
func (*UnimplementedDistributorServiceServer) DeletePark(ctx context.Context, req *DeleteParkRequest) (*emptypb.Empty, error) {
